...
class FollowingAdapter(private val listFoll: ArrayList<Users>): RecyclerView.Adapter<FollowingAdapter.ListFollHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListFollHolder {
        val view: View = LayoutInflater.from (parent.context).inflate(R.layout.item_foll, parent, false)
        return ListFollHolder(view)
    }

    override fun onBindViewHolder(holder: ListFollHolder, position: Int) {
    ...
    inner class ListFollHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
