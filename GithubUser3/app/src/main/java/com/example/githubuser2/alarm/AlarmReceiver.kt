...
import com.example.githubuser2.MainActivity
import com.example.githubuser2.alarm.MyPreferenceFragment
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, type: String, message: String) {
        ...
        val timeArray = TIME_REPEATING.split(":".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()
    ...
    private fun showAlarmNotification(context: Context, message: String) {
        val channelId = "GithubUser"
        val channelName = "GithubUserApp"
